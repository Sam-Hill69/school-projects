...
let htmlCode = "";
//adds each img and caption for how many captions there are in the captions array
for (let i = 0; i < captions.length; i++) {
  htmlCode += "<figure>";

  htmlCode += `<img alt='' src='slide${i}.jpg' />`;

  htmlCode += `<figcaption>caption${captions[i]}</figcaption>`;

  htmlCode += "</figure>";
}
//writes the loop I just created into the webpage
