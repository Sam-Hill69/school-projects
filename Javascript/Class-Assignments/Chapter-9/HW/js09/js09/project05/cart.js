...
function displayCart() {
  let itemsTotalString = sessionStorage.getItem("itemsInCart");
  // Check that there are items in the shopping cart
  if (itemsTotalString) {
    let itemTotal = parseInt(itemsTotalString);
