...
// Check if the owner's name is entered on the cardfunction validateName
...
// Check that a year is selected for the expiratiation date
...
function validateCVC() {
  ...
  if (cvc.validity.valueMissing) {
    ...
    cvc.setCustomValidity("Enter a three digit number");
  } else {
