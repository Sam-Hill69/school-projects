...
//assigns a empty string to the variable htmlCode
let htmlCode = "";
//a for loop to add the html code to the htmlCode variable
...
//assigns the first tbody tag to the tableBody variable
let tableBody = document.getElementsByTagName("tbody")[0];
//inserts the htmlCode into the tbody tags
