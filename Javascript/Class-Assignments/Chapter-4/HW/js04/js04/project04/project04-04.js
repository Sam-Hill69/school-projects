...
// Global variables
let cashBox = document.getElementById("cash"); //added paranthese
let billBox = document.getElementById("bill"); //added paranthese
let changeBox = document.getElementById("change"); //added paranthese

// Event handlers to be run when the cash or bill value changes
cashBox.addEventListener("change", runTheRegister); //added "The"
billBox.addEventListener("change", runTheRegister); //added "The"
...
function calcChange(changeValue) {
  ...
  changeValue -= bill5Amt * 5; //changed from 3 to 5
